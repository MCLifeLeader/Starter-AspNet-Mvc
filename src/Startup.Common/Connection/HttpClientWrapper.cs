...
public class HttpClientWrapper : IHttpClientWrapper
{
    ...
    public IAsyncEnumerable<T?> GetFromJsonAsAsyncEnumerable<T>(string resourcePath, string clientName, CancellationToken cancellationToken = default)
    {
        if(_logger.IsEnabled(LogLevel.Debug)) {_logger.LogDebug("'{Class}.{Method}' called", GetType().Name, nameof(GetFromJsonAsAsyncEnumerable));}
        if (_logger.IsEnabled(LogLevel.Information)) { _logger.LogInformation("Request Resource Path:'{resourcePath}'", resourcePath); }
     
        HttpClient httpClient = HttpClient(clientName);
        IAsyncEnumerable<T?> response = httpClient.GetFromJsonAsAsyncEnumerable<T>(resourcePath, cancellationToken);
    ...
    public async Task<byte[]> GetBytesAsync(string resourcePath, string clientName, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<T> GetObjectAsync<T>(string resourcePath, string clientName, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<T> PostAsync<TK, T>(string resourcePath, TK data, string clientName, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<T> PutAsync<TK, T>(string resourcePath, TK data, string clientName, CancellationToken cancellationToken = default)
    {
        _logger.LogDebug("'{Class}.{Method}<TK, T>' called", GetType().Name, nameof(Put));
    ...
    public async Task<string> DeleteAsync(string resourcePath, string clientName, CancellationToken cancellationToken = default)
    {
